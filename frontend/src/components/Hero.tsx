  ...
  return (
    <section className="hero">
      <div className="wrap">
        ...
        <h1>Надёжные поставки <b>для бизнеса</b></h1>
        <p className="lead">
          Средства гигиены и непродовольственные товары. Проверенные поставщики,
          контроль качества и оперативная доставка по всей России и СНГ.
        </p>
        <div className="cta">
